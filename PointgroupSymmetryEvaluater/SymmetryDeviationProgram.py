...
def find_zaxis(structure,inp_atoms,SymmetryOperations, N_input_zaxis = 5 ,N_input_angles = 1):
...
def find_angle(structure,inp_atoms,SymmetryOperations,Zaxis, N_input_angles = 1):
...
def point_group_deviation(structure,inp_atoms,point_group_symmetry,Point_group_name, SaveStructure = True):
...
Path_To_Symmetry_Operations = r'C:\Users\Villads\Documents\Project_SymmetryDeviation\SymmetryOperationLibrary\Operations'
"""
...
mypath = r'C:\Users\Villads\Documents\Project_SymmetryDeviation\Individual_operations_lastTable\Optimized to operations'

#Use this if entire folder is to be analysed:
...
structures_selected = [
             'pointgroup_S4_Tetranitromethane.xyz',
             ]
...
All point groups must be written into the 'Point_group_names' list. They are then read from the 'operations folder' found in the same folder as this script. 
"""
#D4d and subgroups
point_group_names =[
    'pointgroup_C2',
...
"""
Manual_Zaxis = False
Zaxis = np.array([0,0,1]) #Is not read if  'Manual_Zaxis' is False
Manual_Angle = False
angle = 0
...
for savepath in path_to_structures:
    ...
    for Point_group_name in point_group_names:
        ...
        deviations = point_group_deviation(structure,inp_atoms,point_group_symmetry,Point_group_name, SaveStructure)
        # =============================================================================
        # Script results are saved:
        # =============================================================================
        Save_Results(savepath,Point_group_name,point_group_symmetry_names, deviations)
