import numpy as np
#Set path of the Symmetry library
import sys
sys.path.append(r'C:\Users\Villads\Documents\Project_SoftwareSymmetryDeviation\SymmetryOperationLibrary')
import Save_And_Read_SymOperations
